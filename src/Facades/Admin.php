 ...
 * Class Admin.
 *
 * @method static \MAteDon\Admin\Grid grid($model, \Closure $callable)
 * @method static \MAteDon\Admin\Form form($model, \Closure $callable)
 * @method static \MAteDon\Admin\Show show($model, $callable = null)
 * @method static \MAteDon\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \MAteDon\Admin\Layout\Content content(\Closure $callable = null)
